...
void MakeTnodes (dmodel_t *bm)
{
	...
	tnodes = (tnode_t *)(((uintptr_t)tnodes + 31 )&~(uintptr_t)31);
	tnode_p = tnodes;

	if (!lm_geometry_load(tnodes, numnodes * sizeof(tnode_t))) {
		MakeTnode (0);
		lm_geometry_save(tnodes, numnodes * sizeof(tnode_t));
	}
}
